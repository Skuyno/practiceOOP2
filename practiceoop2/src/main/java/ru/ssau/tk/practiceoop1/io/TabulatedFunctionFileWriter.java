...
public class TabulatedFunctionFileWriter {
    public static void main(String[] args) {
        ...
        try (BufferedWriter arrayWriter = new BufferedWriter(new FileWriter("output/array_function.txt"));
             BufferedWriter linkedListWriter = new BufferedWriter(new FileWriter("output/linked_list_function.txt"))) {
